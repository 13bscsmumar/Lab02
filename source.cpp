...
//void multiplyMat(int **input1, int **input2, int **resultMat,int resultRows, int resultCols, int mat1cols) {
void multiplyMat(shared_ptr<int>input1, shared_ptr<int>input2, shared_ptr<int>resultMat, int resultRows, int resultCols, int mat1cols) {
...
void addMat(shared_ptr<int>input1, shared_ptr<int>input2, shared_ptr<int>resultMat, int matSize) {
...
void subMat(shared_ptr<int>input1, shared_ptr<int>input2, shared_ptr<int>resultMat, int matSize) {
	for (int i = 0; i < matSize; i++) {
		resultMat[i] = new int[matSize];
		for (int j = 0; j < matSize; j++) {
			resultMat[i][j] = input1[i][j] - input2[i][j];
...
void multiplyMatStras(shared_ptr<int>input1, shared_ptr<int>input2, shared_ptr<int>resultMat, int matSize) {
	if (matSize <= 2) {
		...
		*
		*/
		//shared_ptr<int>inputMat1(new int *[mat1Rows]);
		shared_ptr<int>A00 ( new int *[matSize]);
		shared_ptr<int>A01(new int *[matSize]);
		shared_ptr<int>A10(new int *[matSize]);
		shared_ptr<int>A11(new int *[matSize]);
		shared_ptr<int>B00(new int *[matSize]);
		shared_ptr<int>B01(new int *[matSize]);
		shared_ptr<int>B10(new int *[matSize]);
		shared_ptr<int>B11(new int *[matSize]);
		...
		*/
		//shared_ptr<int>addTemp1(new int,[]( int *[matSize]));
		shared_ptr<int>addTemp1(new int *[matSize]);
		shared_ptr<int>addTemp2(new int *[matSize]);
		shared_ptr<int>addTemp3(new int *[matSize]);
		shared_ptr<int>subTemp1(new int *[matSize]);
		shared_ptr<int>subTemp2(new int *[matSize]);
		
		shared_ptr<int>m1(new int *[matSize]);
		shared_ptr<int>m2(new int *[matSize]);
		shared_ptr<int>m3(new int *[matSize]);
		shared_ptr<int>m4(new int *[matSize]);
		shared_ptr<int>m5(new int *[matSize]);
		shared_ptr<int>m6(new int *[matSize]);
		shared_ptr<int>m7(new int *[matSize]);
		...
		*                                   C10 C11
		*/
		shared_ptr<int>C00(new int *[matSize]);
		shared_ptr<int>C01(new int *[matSize]);
		shared_ptr<int>C10(new int *[matSize]);
		shared_ptr<int>C11(new int *[matSize]);
...
void initMat(shared_ptr<int> matrix, int rows, int cols) {
...
void displayMat(shared_ptr<int>matrix, int rows, int cols) {
...
int main(int argc, char* argv[]) {
	...
	shared_ptr<int>inputMat2(new int *[mat2Rows]);

	//int **resultMat = new int *[resultRows];
	shared_ptr<int>resultMat(new int *[resultRows]);

	//int **resultMatStras = new int *[resultRows];
	shared_ptr<int>resultMatStras(new int *[resultRows]);
